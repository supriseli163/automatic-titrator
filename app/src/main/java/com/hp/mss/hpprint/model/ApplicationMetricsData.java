...
import com.jh.automatic_titrator.BuildConfig;
...
//        this.manufacturer = Build.MANUFACTURER;
    ...
    public HashMap<String, String> toMap() {
        ...
        if (this.printLibraryVersion != null)
            map.put(PRINT_LIBRARY_VERSION_LABEL, this.printLibraryVersion);
        ...
        if (this.timezoneDescription != null)
            map.put(TIMEZONE_DESCRIPTION, this.timezoneDescription);
        if (this.timezoneOffsetSeconds != null)
            map.put(TIMEZONE_OFFSET_SECONDS, this.timezoneOffsetSeconds);
