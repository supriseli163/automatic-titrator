 ...
 */
public class DetailVertical extends AbstractViewRenderer {
    ...
    public DetailVertical(Context ctx, int layoutResId, String title1, String title2, String title3, User user, List<Test> tests) {
    ...
    protected void initView(View view) {
        ((TextView) view.findViewById(R.id.export_dv_title1)).setText(title1);
        if (StringUtils.isEmpty(title2)) {
            view.findViewById(R.id.export_dv_title2).setVisibility(View.GONE);
        } else {
            ((TextView) view.findViewById(R.id.export_dv_title2)).setText(title2);
        }
        if (StringUtils.isEmpty(title3)) {
            view.findViewById(R.id.export_dv_title3).setVisibility(View.GONE);
        } else {
            ((TextView) view.findViewById(R.id.export_dv_title3)).setText(title3);
        }
        ...
        ((TextView) view.findViewById(R.id.export_dv_date)).setText(date);
        ((TextView) view.findViewById(R.id.export_dv_time)).setText(time);
        String creator = context.getString(R.string.operator) + ": " + user.getUserName();
        ((TextView) view.findViewById(R.id.export_dv_creator)).setText(creator);
        ...
        ((TextView)view.findViewById(R.id.export_dv_autograph)).setText(autograph);

        ListView listView = (ListView) view.findViewById(R.id.export_dv_lv);
